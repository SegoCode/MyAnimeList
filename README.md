...
[![Commits since tagged version](https://img.shields.io/github/commits-since/SegoCode/MyAnimeList/latest?style=flat-square&label=commits%20since%20tag)](https://github.com/SegoCode/MyAnimeList/releases)
[![GitHub downloads](https://img.shields.io/github/downloads/SegoCode/MyAnimeList/total?style=flat-square&label=downloads)](https://github.com/SegoCode/MyAnimeList/releases)
[![Licencia: PolyForm Noncommercial + GNU AGPL-3.0](https://img.shields.io/badge/License-PolyForm%20Noncommercial%20%2B%20GNU%20AGPL--3.0-blue?style=flat-square)](https://github.com/SegoCode/MyAnimeList/blob/main/LICENSE)
